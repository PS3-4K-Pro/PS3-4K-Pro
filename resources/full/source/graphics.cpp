...
Font F1("/dev_hdd0/game/PS34KPROX/USRDIR/data/fonts/header.ttf", Graphics), F2("/dev_hdd0/game/PS34KPROX/USRDIR/data/fonts/items.ttf", Graphics);
...
Printf PF("/dev_hdd0/game/PS34KPROX/USRDIR/data/log.txt");
